...
<head>
    ...
    <title>Business | Product Referring</title>
</head>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item active" href="#">Product Referal</a></li>
                            <li><a class="dropdown-item" href="#">Multi Level Marketing (MLM)</a></li>
                            <li>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item active" href="productReferal.php">Product Referal</a></li>
...
?>
  ...
  ?>
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://source.unsplash.com/1600x500/?Mobiles,Laptops" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/1600x500/?Watches" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/1600x500/?Bags" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/1600x500/?Jeans" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/1600x500/?Ladies Shuits" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/1600x500/?Cots" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <div class="container my-4">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Refer Our Products And Earn Money</h5>
                <p class="card-text">There are loats of product links which are provided by Next2Me to each user in which he/she can share link of that product to other user after each sell he/she can earn money.</p>
            </div>
            <img src="https://source.unsplash.com/1600x500/?products" class="card-img-bottom" alt="...">
        </div>
        <div class="card my-1">
            <div class="card-body">
                <h5 class="card-title">How Refer System Works</h5>
                <p class="card-text">Next2Me shares links of products to every user, if a user buys that product from his shared link, then in return he gives him Next2Me money so that his motivation increases or if any need of that user is fulfilled.</p>
            </div>
            <img src="../img/refer.png" class="card-img-bottom img-thumbnail" alt="...">
        </div>
    </div>
    <hr>
